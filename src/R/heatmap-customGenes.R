...
my.path <- "../../data/custom.farnesyl.txt"
...
write.table(data.pc9.h3[data.pc9.h3$genes %in% genes,],file=glue("../../data/results/pc9/matrice_heatmap_{filename.genes.list}_patterns.txt"),quote=F,row.names=F,sep="\t")
...
write.table(data.h4.h3[data.h4.h3$genes %in% genes,],file=glue("../../data/results/h4/matrice_heatmap_{filename.genes.list}_patterns.txt"),quote=F,row.names=F,sep="\t")
