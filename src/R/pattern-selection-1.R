...
dir.create(file.path("../../data/results/", glue("genes_{linear.FC}_{linear.stable_FC}")), showWarnings = FALSE)
...
write.table(sort(pc9.genes.pattern1A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern1A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern1B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern1B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern1A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern1A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern1B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern1B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern2A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern2A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern2B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern2B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern2A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern2A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern2B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern2B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern3A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern3A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern3B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern3B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern3A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern3A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern3B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern3B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern4A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern4A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(pc9.genes.pattern4B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/pc9.genes.pattern4B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern4A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern4A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(h4.genes.pattern4B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/h4.genes.pattern4B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern1A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern1A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern1B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern1B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern2A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern2A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern2B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern2B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern3A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern3A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern3B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern3B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern4A),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern4A.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
write.table(sort(intersect.pattern4B),file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/intersect.pattern4B.txt"),quote=F,row.names=F,sep="\t",col.names=F)
...
#write.table(filter(data.h4.pc9.h3, genes%in%  my.genes),file=glue("../../data/results/custom_matrice_heatmap_all_patterns.txt"),quote=F,row.names=F,sep="\t")
...
write.table(data.h4.pc9.h3[data.h4.pc9.h3$pattern!=0,],file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/matrice_heatmap_intersect_patterns.txt"),quote=F,row.names=F,sep="\t")
...
#write.table(data.h4.pc9.h3,file=glue("../../data/results/matrice_heatmap_pc9_patterns.txt"),quote=F,row.names=F,sep="\t")
...
#write.table(data.h4.pc9.h3,file=glue("../../data/results/matrice_heatmap_h4_patterns.txt"),quote=F,row.names=F,sep="\t")
...
write.table(data.h4.pc9.h3.pc9Contrast,file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/matrice_heatmap_pc9_contrasted_patterns.txt"),quote=F,row.names=F,sep="\t")
...
write.table(countspc9,file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/freq_pc9_contrasted_patterns.txt"),quote=F,row.names=F,sep="\t")
write.table(countsh4,file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/freq_h4_contrasted_patterns.txt"),quote=F,row.names=F,sep="\t")


write.table(data.h4.pc9.h3.h4Contrast,file=glue("../../data/results/genes_{linear.FC}_{linear.stable_FC}/matrice_heatmap_h4_contrasted_patterns.txt"),quote=F,row.names=F,sep="\t")
...
#print(primary.vs.meta.genes.pattern1)
#write.table(primary.vs.meta.genes.pattern1,file=glue("../../data/results/primary.vs.meta.pattern1.txt"),quote=F,row.names=F,sep="\t")
...
#print(primary.vs.meta.genes.pattern4)
#write.table(primary.vs.meta.genes.pattern4,file=glue("../../data/results/primary.vs.meta.pattern4.txt"),quote=F,row.names=F,sep="\t")
...
#write.table(filter(data.primary.vs.meta, genes %in%  my.genes),file=glue("../../data/results/custom_matrice_heatmap_primary_vs_meta.txt"),quote=F,row.names=F,sep="\t")
...
#write.table(data.primary.vs.meta,file=glue("../../data/results/matrice_heatmap_primary_vs_meta.txt"),quote=F,row.names=F,sep="\t")
